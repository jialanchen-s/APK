...
import type { PriceQueryRecord, PriceQueryResponse, ArchiveDomain } from '@shared/api.interface';
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-muted-foreground">合同库</label>
              <Select
                value={domain}
                onValueChange={(v) => setDomain(v as ArchiveDomain)}
              >
                <SelectTrigger className="rounded-xl">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="rounded-xl">
                  <SelectItem value="welding">焊装合同库</SelectItem>
                  <SelectItem value="manufacturing">总装费用合同库</SelectItem>
                  <SelectItem value="painting">涂装费用合同库</SelectItem>
                  <SelectItem value="stamping">冲压费用合同库</SelectItem>
                </SelectContent>
              </Select>
            </div>
