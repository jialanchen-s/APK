...
import { AuthorizationSDK, NeedLogin, Can } from '@lark-apaas/fullstack-nestjs-core';
import type { MemberMutationData, MemberType } from '@lark-apaas/fullstack-nestjs-core';
