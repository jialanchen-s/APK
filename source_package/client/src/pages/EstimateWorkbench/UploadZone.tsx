...
import type { LineType, EstimateMode, EstimateTaskRow } from '@shared/api.interface';
...
const UploadZone = ({ onTaskCreated }: UploadZoneProps) => {
    ...
    <Card className="rounded-3xl shadow-sm border border-gray-100">
      ...
      <div className="flex items-center justify-between px-6 pt-5 pb-3 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-foreground ml-2">测算模式</span>
          <Select
            value={estimateMode}
