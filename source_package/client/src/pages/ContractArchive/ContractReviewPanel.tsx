...
import type { ContractReviewBatch, ContractReviewDetailItem } from '@shared/api.interface';
...
const ContractReviewPanel = () => {
  ...
  const loadDetail = useCallback(async (batchId: string, page: number) => {
    setDetailLoading(true);
    try {
      const res = await getBatchDetail(batchId, page, DETAIL_PAGE_SIZE);
            ...
            <div className="flex items-center gap-1">
              <Button
                ...
                onClick={() => {
                  ...
                  setDetailPage(next);
                  if (detailBatch) void loadDetail(detailBatch.batchId, next);
                }}
              >
